...
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/repos/brave.repo
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/repos/docker-ce.repo
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/repos/google-chrome.repo
#dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/repos/k8s.repo
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/repos/slack.repo
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/repos/teamviewer.repo
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/repos/virtualbox.repo
#dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/repos/cuda-rhel10.repo

dnf install -y epel-release rpmfusion-free-release https://mirrors.rpmfusion.org/nonfree/el/rpmfusion-nonfree-release-10.noarch.rpm
...
pacotes="${pacotes} pulsar meld kolourpaint geany"
...
if [ "${devel}" = yes ]; then
  pacotes=""
  pacotes="${pacotes} java-latest-openjdk java-latest-openjdk-devel maven"
...
wget https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky10/confs/chrony.conf -O /etc/chrony.conf
