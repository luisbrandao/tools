...
repos="${repos} http://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-25.noarch.rpm"
repos="${repos} http://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-25.noarch.rpm"
