...
if ${local} ; then
  dnf config-manager --disable appstream baseos powertools extras epel epel-modular
	dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky-8-repos/rocky8-techsytes.repo
else
...
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky-8-repos/brave.repo
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky-8-repos/google-chrome.repo
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky-8-repos/docker.repo
dnf config-manager --add-repo https://raw.githubusercontent.com/luisbrandao/tools/master/linuxInstall/rocky-8-repos/slack.repo
